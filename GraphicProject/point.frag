...
void main()
{
	...
	fragment = costheta * vec4(diffuseout, 1.0) *  vec4(pointlightintensityout, 1.0) + vec4(ambientintensityout.x * diffuseout.x, ambientintensityout.y * diffuseout.y, ambientintensityout.z * diffuseout.z, 1.0);
