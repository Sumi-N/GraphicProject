...
void main()
{
	fragment = texture2D(gSampler, TexCoord0.st) * vec4(ambientintensityout.x * diffuseout.x, ambientintensityout.y * diffuseout.y, ambientintensityout.z * diffuseout.z, 1.0);
